#include "CanonCameraWrapper.h"
    ...
    bool CanonCameraWrapper::keepCameraAlive(){

        EdsError err = EDS_ERR_OK;

        err = EdsSendCommand(theCamera, kEdsCameraCommand_ExtendShutDownTimer, 0);
    ...
    bool CanonCameraWrapper::hasDownloaded(){
...
//        }
    ...
    bool CanonCameraWrapper::isTransfering(){
     ...
     bool CanonCameraWrapper::isDownloading(){
    ...
    bool CanonCameraWrapper::downloadImage(EdsDirectoryItemRef directoryItem){
        ...
        if(err == EDS_ERR_OK){
            ...
            int counter = 0;
            ofNotifyEvent(newIntEvent,counter,this);
